...
public class QuizSolutionTest {
    ...
    @Test
    public void testFindAllCorrectSixQuestionTwoAllRight(){
        Gradeable s1 = new Student();
        Gradeable s2 = new Student();
        Gradeable s3 = new Student();
        QuizSolution quiz = new QuizSolution(true,true,true,true,true, true);
        s1.setAnswers(true,true,true,false,false, false);
        s2.setAnswers(false,true,true,true,false, false);
        s3.setAnswers(true,false,true,true,true, true);
        ArrayList<Gradeable> students = new ArrayList<>();
        students.add(s1); students.add(s2); students.add(s3);
        quiz.gradeStudent(s1);
        quiz.gradeStudent(s2);
